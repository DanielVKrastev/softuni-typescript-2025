...
export function decorator2(target: object, methodName: string, desciptor: PropertyDescriptor){}
export function decorator3(target: object, methodName: string, desciptor: PropertyDescriptor){}
